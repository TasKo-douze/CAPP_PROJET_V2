Public Class RecapitulatifForm
    ...
    ' Prix
    Public PrixBase As Decimal
    Public SupplementBagages As Decimal
    Public PrixTotal As Decimal
    ...
    Private Sub ChargerReservation()
        ...
        txtListePassagers.Clear()

        For i As Integer = 0 To ListePassagers.Count - 1

            txtListePassagers.AppendText(
                ListePassagers(i) &
                " - Bagage : " &
                ListeBagages(i) &
                " kg" &
        ...
        Dim prixBase As Decimal = 450

        Dim prixTotal As Decimal = prixBase + SupplementBagages
